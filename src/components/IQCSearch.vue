    ...
    <div>
        <el-card style="background-color: rgb(255, 255, 255);" v-loading.fullscreen.lock="loading">
            <el-form inline label-width="80px">
                <el-form-item label="查詢條件">
                    <el-radio-group v-model="search_mode">
                        <el-radio label="1">驗收單號</el-radio>
                        <el-radio label="2">批號</el-radio>
                ...
                <el-form-item label=" ">
                    <el-button icon="el-icon-download" type="warning" @click="saveImage">下載PNG圖片</el-button>
                </el-form-item>
            </el-form>
                        ...
                        <el-col :span="8">
                            <el-form-item label="驗收單號">
                                <el-input style="width: 200px;" v-model="lot" @keyup.enter.native="Search_IQC2"
                                    :disabled="lot_disabled"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
        ...
        <el-dialog title="日期查询" :visible.sync="timevisible">
            <el-form lable-width="80px" inline>
                <el-form-item label="物料">
                    <el-select v-model="component" filterable>
                ...
                <el-form-item label=" ">
                    ...
                    <el-button icon="el-icon-search" type="primary" @click="handle_SIPsearch">Search SIP</el-button>
                    <el-button icon="el-icon-refresh" type="primary" @click="handle_refresh">Reset</el-button>
                </el-form-item>
            </el-form>
            <hr>
            <div v-bind:style="{display:lotdisplay}">
            ...
            <div v-bind:style="{display:sipdisplay}">
                <iqc_sip :key="i"></iqc_sip>
            </div>
...
<script>
    ...
    import { SearchInfo, DownLoad, DownDetail } from './../api/index.js'
    import bus from './bus';
    import iqc_sip from './IQC_SPI.vue'
    ...
    export default {
        ...
        created() {
            ...
            this.sipdisplay = "none";
            this.lotdisplay = "block";
        },
        components: {
            iqc_sip,
        },
        methods: {
            ...
            handle_openfile(row) {
                ...
                tempwindow.location = "http://10.35.7.220:8016/55/" + row.REPORT_FILE;
            ...
            handle_SIPsearch() {
                if (this.component == "") {
                    this.$message({ message: "請選擇物料", type: "warning" });
                }
                else if (this.first == "" || this.second == "") {
                    this.$message({ message: "請選擇日期", type: "warning" });
                }
                else if (this.second < this.first) {
                    this.$message({ message: "結束日期不能小於開始日期", type: "warning" });
                }
                else {
                    this.currentPage = 1;
                    this.current_change(1);
                    ...
                    this.sipdisplay = "block";
                    this.lotdisplay = "none";
                    var params = {
                        component: this.component,
                        first: this.first,
                        second: this.second
                    ...
                    this.$store.commit("setsip", params);
                    ++this.i;
                }
            }
        }
